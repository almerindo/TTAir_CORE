...
public class TTAirXmlToGraphviz2 {
	...
	private List<String> listNodeBF = new ArrayList<String>();
	...
	public List<String> getListNodeBF() {
		return listNodeBF;
	}



	public void setListNodeBF(List<String> listNodeBF) {
		this.listNodeBF = listNodeBF;
	}
